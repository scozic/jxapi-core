...
/**
 * Snippet to test call to {@link EmployeeV1Api#deleteEmployee(java.lang.Integer)})}<br>
 */
...
public class EmployeeV1DeleteEmployeeDemo {
  ...
  public static Integer createId(Properties properties) {
    return EmployeeDemoProperties.V1.Rest.DeleteEmployee.getId(properties);
  }
  
  /**
   * Submits a call to {@link EmployeeV1Api#deleteEmployee(java.lang.Integer)}and waits for response.
   ...
   */
  public static RestResponse<String> execute(Integer request, Properties configProperties, ExchangeObserver observer) throws InterruptedException, ExecutionException {
    ...
    try {
      return DemoUtil.checkResponse(api.deleteEmployee(request));
    }
    finally {
      if (observer != null) {
  ...
  /**
   * Runs REST endpoint demo snippet calling {@link EmployeeV1Api#deleteEmployee(java.lang.Integer)}
