...
public class WebsocketEndpointDemoGeneratorTest {
  ...
  public void testGenerateWebsocketEndpointDemoObjectRequest() throws Exception {
    ...
    Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
        ...
        + "import com.foo.bar.gen.marketdata.MyTestExchangeMarketDataConstants;\n"
        ...
        + "    request.setSymbol(EncodingUtil.substituteArguments(\"${constants.allTickers}\", \"constants.allTickers\", MyTestExchangeMarketDataConstants.ALL_TICKERS));\n"
