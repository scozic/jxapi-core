...
public class ExchangeApiInterfaceImplementationGeneratorTest {
  ...
  public void testGenerateExchangeApiDifferentRestEndpointQueryParamsDefinitions() throws Exception {
    ...
    Assert.assertEquals("package com.foo.bar.gen.restapi;\n"
        ...
        + "    return submit(HttpRequest.create(PUT_REST_REQUEST_DATA_TYPE_OBJECT_USING_DEFAULT_QUERY_PARAMS_REST_API, url, HttpMethod.PUT, request, null, 0), putRestRequestDataTypeObjectUsingDefaultQueryParamsResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_INT_LIST_AS_QUERY_PARAM_REST_API, url, HttpMethod.POST, request, null, 0), postRestRequestDataTypeIntListAsQueryParamResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
