...
public class ExchangeApiInterfaceImplementationGeneratorTest {
  ...
  public void testGenerateExchangeApiDifferentRestEndpointQueryParamsDefinitions() throws Exception {
    ...
    Assert.assertEquals("package com.foo.bar.gen.restapi;\n"
        ...
        + "    String urlParameters = EncodingUtil.createUrlQueryParameters(\"id\", request);\n"
        + "    return submit(HttpRequest.create(DELETE_REST_REQUEST_DATA_TYPE_INT_REST_API, deleteRestRequestDataTypeIntHttpUrl + urlParameters, HttpMethod.DELETE, request, null, 0), deleteRestRequestDataTypeIntResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    String urlParameters = EncodingUtil.createUrlQueryParameters(\"age\", request.getAge(), \"city\", request.getCity());\n"
        + "    return submit(HttpRequest.create(DELETE_REST_REQUEST_DATA_TYPE_OBJECT_REST_API, deleteRestRequestDataTypeObjectHttpUrl + urlParameters, HttpMethod.DELETE, request, null, 0), deleteRestRequestDataTypeObjectResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
