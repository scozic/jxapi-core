...
public class ExchangeApiInterfaceImplementationGeneratorTest {
  ...
  public void testGenerateExchangeApiSpecificRequestDataTypes() throws Exception {
    ...
    Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
        ...
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_LONG_REST_API, postRestRequestDataTypeLongHttpUrl, HttpMethod.POST, request, null, 0), postRestRequestDataTypeLongResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<GenericResponse> postRestRequestDataTypeBigDecimal(BigDecimal request) {\n"
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_BIG_DECIMAL_REST_API, postRestRequestDataTypeBigDecimalHttpUrl, HttpMethod.POST, request, null, 0), postRestRequestDataTypeBigDecimalResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<GenericResponse> postRestRequestDataTypeStringImplicit(String request) {\n"
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_STRING_IMPLICIT_REST_API, postRestRequestDataTypeStringImplicitHttpUrl, HttpMethod.POST, request, null, 0), postRestRequestDataTypeStringImplicitResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<GenericResponse> postRestRequestDataTypeBoolean(Boolean request) {\n"
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_BOOLEAN_REST_API, postRestRequestDataTypeBooleanHttpUrl, HttpMethod.POST, request, null, 0), postRestRequestDataTypeBooleanResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<GenericResponse> postRestRequestDataTypeObjectNoParameters() {\n"
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_OBJECT_NO_PARAMETERS_REST_API, postRestRequestDataTypeObjectNoParametersHttpUrl, HttpMethod.POST, null, null, 0), postRestRequestDataTypeObjectNoParametersResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_OBJECT_ONE_PARAMETER_REST_API, postRestRequestDataTypeObjectOneParameterHttpUrl, HttpMethod.POST, request, null, 0), postRestRequestDataTypeObjectOneParameterResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
  ...
  public void testGenerateExchangeApiDifferentRestEndpointQueryParamsDefinitions() throws Exception {
    ...
    Assert.assertEquals("package com.foo.bar.gen.restapi;\n"
        ...
        + "   */\n"
        + "  protected final String getRestRequestDataTypeStringListWithCustomListSeparatorHttpUrl;\n"
        + "  \n"
        + "  /**\n"
        ...
        + "   */\n"
        + "  protected final String putRestRequestDataTypeObjectUsingCustomQueryParamsHttpUrl;\n"
        + "  \n"
        + "  /**\n"
        ...
        + "    this.getRestRequestDataTypeStringListWithCustomListSeparatorHttpUrl = EncodingUtil.buildUrl(this.getHttpUrl(), \"/getRestRequestDataTypeStringListWithCustomListSeparator\");\n"
        ...
        + "    this.putRestRequestDataTypeObjectHttpUrl = EncodingUtil.buildUrl(this.getHttpUrl(), \"/putRestRequestDataTypeObject\");\n"
        + "    this.putRestRequestDataTypeObjectUsingCustomQueryParamsHttpUrl = EncodingUtil.buildUrl(this.getHttpUrl(), \"/putRestRequestDataTypeObjectUsingCustomQueryParams\");\n"
        ...
        + "    return submit(HttpRequest.create(DELETE_REST_REQUEST_DATA_TYPE_INT_REST_API, deleteRestRequestDataTypeIntHttpUrl, HttpMethod.DELETE, request, null, 0), deleteRestRequestDataTypeIntResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(DELETE_REST_REQUEST_DATA_TYPE_OBJECT_REST_API, deleteRestRequestDataTypeObjectHttpUrl, HttpMethod.DELETE, request, null, 0), deleteRestRequestDataTypeObjectResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<GenericResponse> putRestRequestDataTypeObject(Person request) {\n"
        + "    return submit(HttpRequest.create(PUT_REST_REQUEST_DATA_TYPE_OBJECT_REST_API, putRestRequestDataTypeObjectHttpUrl, HttpMethod.PUT, request, null, 0), putRestRequestDataTypeObjectResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
