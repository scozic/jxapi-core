...
public class ExchangeApiInterfaceImplementationGeneratorTest {
  ...
  public void testGenerateExchangeApiSpecificRequestDataTypes() throws Exception {
    ...
    Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
        ...
        + "    String url = new StringBuilder(128).append(deletetRestRequestDataTypeObjectAsBodyHttpUrl)\n"
        + "      .append(EncodingUtil.createUrlQueryParameters(\"s\", request.getSymbol())).toString();\n"
        + "    return submit(HttpRequest.create(DELETET_REST_REQUEST_DATA_TYPE_OBJECT_AS_BODY_REST_API, url, HttpMethod.DELETE, request, null, 0), true, deletetRestRequestDataTypeObjectAsBodyResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
