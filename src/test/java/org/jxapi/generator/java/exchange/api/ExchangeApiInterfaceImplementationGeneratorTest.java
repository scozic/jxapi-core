...
public class ExchangeApiInterfaceImplementationGeneratorTest {
  ...
  public void testGenerateExchangeApiWithGlobalRateLimits() throws Exception {
    ...
    Assert.assertEquals("package com.foo.bar.gen.trading;\n"
        ...
        + "    String urlParameters = EncodingUtil.createUrlQueryParameters(\"symbols\", JsonUtil.pojoToJsonString(request.getSymbols()));\n"
        + "    log.debug(\"GET exchangeInfo > {}\", request);\n"
        + "    return submit(HttpRequest.create(EXCHANGE_INFO_REST_API, EXCHANGE_INFO_URL + urlParameters, HttpMethod.GET, request, null, 60, null), exchangeInfoResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
  ...
  public void testGenerateExchangeApiWithEndpointSpecificRateLimits() throws Exception {
    ...
    Assert.assertEquals("package com.foo.bar.gen.futuresmarketdata;\n"
        ...
        + "    String urlParameters = EncodingUtil.createUrlQueryParameters(\"symbols\", JsonUtil.pojoToJsonString(request.getSymbols()));\n"
        + "    log.debug(\"GET exchangeInfo > {}\", request);\n"
        + "    return submit(HttpRequest.create(EXCHANGE_INFO_REST_API, EXCHANGE_INFO_URL + urlParameters, HttpMethod.GET, request, exchangeInfoRateLimits, 0, null), exchangeInfoResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(EXCHANGE_INFO2_REST_API, EXCHANGE_INFO2_URL + urlParameters, HttpMethod.GET, request, null, 0, null), exchangeInfo2ResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
  ...
  public void testGenerateExchangeApiWithBothApiGlobalAndEndpointSpecificRateLimits() throws Exception {
    ...
    Assert.assertEquals("package com.foo.bar.gen.futurestrading;\n"
        ...
        + "    String urlParameters = EncodingUtil.createUrlQueryParameters(\"symbols\", JsonUtil.pojoToJsonString(request.getSymbols()));\n"
        + "    log.debug(\"GET exchangeInfo > {}\", request);\n"
        + "    return submit(HttpRequest.create(EXCHANGE_INFO_REST_API, EXCHANGE_INFO_URL + urlParameters, HttpMethod.GET, request, exchangeInfoRateLimits, 60, null), exchangeInfoResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
