...
public class ExchangeApiInterfaceImplementationGeneratorTest {
  ...
  public void testGenerateExchangeApiSpecificResponseDataTypes() throws Exception {
    ...
    Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
        ...
        + "  \n"
        + "  /**\n"
        + "   * URL for <i>getRestResponseDataTypeRawObject</i> REST endpoint.\n"
        + "   * @see MyTestExchangeMarketDataApi#getRestResponseDataTypeRawObject()\n"
        + "   */\n"
        + "  protected final String getRestResponseDataTypeRawObjectHttpUrl;\n"
        + "  \n"
        + "  /**\n"
        + "   * URL for <i>getRestResponseDataTypeExternalObject</i> REST endpoint.\n"
        + "   * @see MyTestExchangeMarketDataApi#getRestResponseDataTypeExternalObject()\n"
        + "   */\n"
        + "  protected final String getRestResponseDataTypeExternalObjectHttpUrl;\n"
        + "  \n"
        + "  // Websocket endpoints\n"
        ...
        + "  \n"
        + "  // Message deserializers\n"
        + "  private final MessageDeserializer<Integer> getRestResponseDataTypeIntResponseDeserializer = IntegerJsonFieldDeserializer.getInstance();\n"
        + "  private final MessageDeserializer<Long> getRestResponseDataTypeLongResponseDeserializer = LongJsonFieldDeserializer.getInstance();\n"
        + "  private final MessageDeserializer<BigDecimal> getRestResponseDataTypeBigDecimalResponseDeserializer = BigDecimalJsonFieldDeserializer.getInstance();\n"
        + "  private final MessageDeserializer<String> getRestResponseDataTypeStringResponseDeserializer = StringJsonFieldDeserializer.getInstance();\n"
        + "  private final MessageDeserializer<Boolean> getRestResponseDataTypeBooleanResponseDeserializer = BooleanJsonFieldDeserializer.getInstance();\n"
        ...
        + "  private final MessageDeserializer<String> getRestEmptyResponseDataTypeResponseDeserializer = MessageDeserializer.NO_OP;\n"
        + "  private final MessageDeserializer<Object> getRestResponseDataTypeRawObjectResponseDeserializer = RawObjectJsonFieldDeserializer.getInstance();\n"
        + "  private final MessageDeserializer<ExternalObject> getRestResponseDataTypeExternalObjectResponseDeserializer = new GenericObjectJsonFieldDeserializer<>(ExternalObject.class);\n"
        + "  \n"
        + "  // Constructor\n"
        + "  /**\n"
        + "   * Constructor\n"
        ...
        + "    this.getRestResponseDataTypeRawObjectHttpUrl = EncodingUtil.buildUrl(this.getHttpUrl(), \"https://com.sample.mycex/getEmptyResponse\");\n"
        + "    this.getRestResponseDataTypeExternalObjectHttpUrl = EncodingUtil.buildUrl(this.getHttpUrl(), \"https://com.sample.mycex/getStringList\");\n"
        + "    createWebsocketManager(this.wsUrl, \"com.foo.bar.BarWebsocketFactory\", \"com.foo.bar.BarWebsocketHookFactory\");\n"
        ...
        + "    return submit(HttpRequest.create(GET_REST_RESPONSE_DATA_TYPE_INT_REST_API, getRestResponseDataTypeIntHttpUrl, HttpMethod.GET, null, null, 0), getRestResponseDataTypeIntResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<Long> getRestResponseDataTypeLong() {\n"
        + "    return submit(HttpRequest.create(GET_REST_RESPONSE_DATA_TYPE_LONG_REST_API, getRestResponseDataTypeLongHttpUrl, HttpMethod.GET, null, null, 0), getRestResponseDataTypeLongResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<BigDecimal> getRestResponseDataTypeBigDecimal() {\n"
        + "    return submit(HttpRequest.create(GET_REST_RESPONSE_DATA_TYPE_BIG_DECIMAL_REST_API, getRestResponseDataTypeBigDecimalHttpUrl, HttpMethod.GET, null, null, 0), getRestResponseDataTypeBigDecimalResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<String> getRestResponseDataTypeString() {\n"
        + "    return submit(HttpRequest.create(GET_REST_RESPONSE_DATA_TYPE_STRING_REST_API, getRestResponseDataTypeStringHttpUrl, HttpMethod.GET, null, null, 0), getRestResponseDataTypeStringResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<Boolean> getRestResponseDataTypeBoolean() {\n"
        + "    return submit(HttpRequest.create(GET_REST_RESPONSE_DATA_TYPE_BOOLEAN_REST_API, getRestResponseDataTypeBooleanHttpUrl, HttpMethod.GET, null, null, 0), getRestResponseDataTypeBooleanResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<MyTestExchangeMarketDataGetRestResponseDataTypeObjectResponse> getRestResponseDataTypeObject() {\n"
        + "    return submit(HttpRequest.create(GET_REST_RESPONSE_DATA_TYPE_OBJECT_REST_API, getRestResponseDataTypeObjectHttpUrl, HttpMethod.GET, null, null, 0), getRestResponseDataTypeObjectResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<List<Integer>> getRestResponseDataTypeIntList() {\n"
        + "    return submit(HttpRequest.create(GET_REST_RESPONSE_DATA_TYPE_INT_LIST_REST_API, getRestResponseDataTypeIntListHttpUrl, HttpMethod.GET, null, null, 0), getRestResponseDataTypeIntListResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(GET_REST_RESPONSE_DATA_TYPE_OBJECT_LIST_MAP_REST_API, getRestResponseDataTypeObjectListMapHttpUrl, HttpMethod.GET, null, null, 0), getRestResponseDataTypeObjectListMapResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<String> getRestEmptyResponseDataType() {\n"
        + "    return submit(HttpRequest.create(GET_REST_EMPTY_RESPONSE_DATA_TYPE_REST_API, getRestEmptyResponseDataTypeHttpUrl, HttpMethod.GET, null, null, 0), getRestEmptyResponseDataTypeResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<Object> getRestResponseDataTypeRawObject() {\n"
        + "    return submit(HttpRequest.create(GET_REST_RESPONSE_DATA_TYPE_RAW_OBJECT_REST_API, getRestResponseDataTypeRawObjectHttpUrl, HttpMethod.GET, null, null, 0), getRestResponseDataTypeRawObjectResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<ExternalObject> getRestResponseDataTypeExternalObject() {\n"
        + "    return submit(HttpRequest.create(GET_REST_RESPONSE_DATA_TYPE_EXTERNAL_OBJECT_REST_API, getRestResponseDataTypeExternalObjectHttpUrl, HttpMethod.GET, null, null, 0), getRestResponseDataTypeExternalObjectResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  \n"
        + "  // Websocket endpoint subscribe/unsubscribe methods implementations\n"
  ...
  public void testGenerateExchangeApiSpecificRequestDataTypes() throws Exception {
    ...
    Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
        ...
        + "import com.foo.bar.gen.marketdata.serializers.MyTestExchangeMarketDataPostRestRequestDataTypeObjectOneParameterRequestSerializer;\n"
        + "import com.foo.bar.gen.marketdata.serializers.SingleSymbolSerializer;\n"
        + "import javax.annotation.processing.Generated;\n"
        + "import org.jxapi.exchange.AbstractExchangeApi;\n"
        + "import org.jxapi.netutils.deserialization.MessageDeserializer;\n"
        + "import org.jxapi.netutils.rest.FutureRestResponse;\n"
        ...
        + "  \n"
        + "  /**\n"
        + "   * URL for <i>postRestRequestNoParameters</i> REST endpoint.\n"
        + "   * @see MyTestExchangeMarketDataApi#postRestRequestNoParameters()\n"
        + "   */\n"
        + "  protected final String postRestRequestNoParametersHttpUrl;\n"
        + "  \n"
        + "  /**\n"
        ...
        + "  \n"
        + "  /**\n"
        + "   * URL for <i>getRestRequestDataTypeExternalObject</i> REST endpoint.\n"
        + "   * @see MyTestExchangeMarketDataApi#getRestRequestDataTypeExternalObject(ExternalObject)\n"
        + "   */\n"
        + "  protected final String getRestRequestDataTypeExternalObjectHttpUrl;\n"
        + "  \n"
        + "  /**\n"
        + "   * URL for <i>postRestRequestDataTypeRawObject</i> REST endpoint.\n"
        + "   * @see MyTestExchangeMarketDataApi#postRestRequestDataTypeRawObject(Object)\n"
        + "   */\n"
        + "  protected final String postRestRequestDataTypeRawObjectHttpUrl;\n"
        + "  \n"
        + "  /**\n"
        ...
        + "  private final MessageSerializer<Long> postRestRequestDataTypeLongRequestSerializer = LongJsonValueSerializer.getInstance();\n"
        + "  private final MessageSerializer<BigDecimal> postRestRequestDataTypeBigDecimalRequestSerializer = BigDecimalJsonValueSerializer.getInstance();\n"
        + "  private final MessageSerializer<String> postRestRequestDataTypeStringImplicitRequestSerializer = StringJsonValueSerializer.getInstance();\n"
        + "  private final MessageSerializer<Boolean> postRestRequestDataTypeBooleanRequestSerializer = BooleanJsonValueSerializer.getInstance();\n"
        + "  private final MessageSerializer<MyTestExchangeMarketDataPostRestRequestDataTypeObjectOneParameterRequest> postRestRequestDataTypeObjectOneParameterRequestSerializer = new MyTestExchangeMarketDataPostRestRequestDataTypeObjectOneParameterRequestSerializer();\n"
        + "  private final MessageSerializer<List<Integer>> postRestRequestDataTypeIntListWithDefaultValueRequestSerializer = new ListJsonValueSerializer<>(IntegerJsonValueSerializer.getInstance());\n"
        ...
        + "  private final MessageSerializer<Map<String, List<SingleSymbol>>> deletetRestRequestDataTypeObjectAsBodyRequestSerializer = new MapJsonValueSerializer<>(new ListJsonValueSerializer<>(new SingleSymbolSerializer()));\n"
        + "  private final MessageSerializer<ExternalObject> getRestRequestDataTypeExternalObjectRequestSerializer = ObjectJsonValueSerializer.getInstance();\n"
        + "  private final MessageSerializer<Object> postRestRequestDataTypeRawObjectRequestSerializer = ObjectJsonValueSerializer.getInstance();\n"
        + "  \n"
        + "  // Message deserializers\n"
        ...
        + "  private final MessageDeserializer<GenericResponse> postRestRequestNoParametersResponseDeserializer = new GenericResponseDeserializer();\n"
        ...
        + "  private final MessageDeserializer<GenericResponse> getRestRequestDataTypeExternalObjectResponseDeserializer = new GenericResponseDeserializer();\n"
        + "  private final MessageDeserializer<GenericResponse> postRestRequestDataTypeRawObjectResponseDeserializer = new GenericResponseDeserializer();\n"
        ...
        + "    this.postRestRequestNoParametersHttpUrl = EncodingUtil.buildUrl(this.getHttpUrl(), \"/postNoParameter\");\n"
        ...
        + "    this.getRestRequestDataTypeExternalObjectHttpUrl = EncodingUtil.buildUrl(this.getHttpUrl(), \"/postEmptyObject\");\n"
        + "    this.postRestRequestDataTypeRawObjectHttpUrl = EncodingUtil.buildUrl(this.getHttpUrl(), \"/postEmptyObject\");\n"
        ...
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_LONG_REST_API, postRestRequestDataTypeLongHttpUrl, HttpMethod.POST, request, null, 0, postRestRequestDataTypeLongRequestSerializer.serialize(request)), postRestRequestDataTypeLongResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<GenericResponse> postRestRequestDataTypeBigDecimal(BigDecimal request) {\n"
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_BIG_DECIMAL_REST_API, postRestRequestDataTypeBigDecimalHttpUrl, HttpMethod.POST, request, null, 0, postRestRequestDataTypeBigDecimalRequestSerializer.serialize(request)), postRestRequestDataTypeBigDecimalResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<GenericResponse> postRestRequestDataTypeStringImplicit(String request) {\n"
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_STRING_IMPLICIT_REST_API, postRestRequestDataTypeStringImplicitHttpUrl, HttpMethod.POST, request, null, 0, postRestRequestDataTypeStringImplicitRequestSerializer.serialize(request)), postRestRequestDataTypeStringImplicitResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_INT_IMPLICIT_AS_PATH_PARAM_REST_API, url, HttpMethod.POST, request, null, 0), postRestRequestDataTypeIntImplicitAsPathParamResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<GenericResponse> postRestRequestDataTypeBoolean(Boolean request) {\n"
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_BOOLEAN_REST_API, postRestRequestDataTypeBooleanHttpUrl, HttpMethod.POST, request, null, 0, postRestRequestDataTypeBooleanRequestSerializer.serialize(request)), postRestRequestDataTypeBooleanResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<GenericResponse> postRestRequestNoParameters(String request) {\n"
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_NO_PARAMETERS_REST_API, postRestRequestNoParametersHttpUrl, HttpMethod.POST, request, null, 0, request), postRestRequestNoParametersResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_OBJECT_ONE_PARAMETER_REST_API, postRestRequestDataTypeObjectOneParameterHttpUrl, HttpMethod.POST, request, null, 0, postRestRequestDataTypeObjectOneParameterRequestSerializer.serialize(request)), postRestRequestDataTypeObjectOneParameterResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_INT_LIST_WITH_DEFAULT_VALUE_REST_API, postRestRequestDataTypeIntListWithDefaultValueHttpUrl, HttpMethod.POST, request, null, 0, postRestRequestDataTypeIntListWithDefaultValueRequestSerializer.serialize(request)), postRestRequestDataTypeIntListWithDefaultValueResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(DELETET_REST_REQUEST_DATA_TYPE_OBJECT_AS_BODY_REST_API, deletetRestRequestDataTypeObjectAsBodyHttpUrl, HttpMethod.DELETE, request, null, 0, deletetRestRequestDataTypeObjectAsBodyRequestSerializer.serialize(request)), deletetRestRequestDataTypeObjectAsBodyResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(DELETET_REST_REQUEST_DATA_TYPE_OBJECT_AS_QUERY_PARAMS_REST_API, url, HttpMethod.DELETE, request, null, 0), deletetRestRequestDataTypeObjectAsQueryParamsResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(GET_REST_REQUEST_DATA_TYPE_EMPTY_OBJECT_REST_API, getRestRequestDataTypeEmptyObjectHttpUrl, HttpMethod.GET, null, null, 0), getRestRequestDataTypeEmptyObjectResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<GenericResponse> getRestRequestDataTypeExternalObject(ExternalObject request) {\n"
        + "    return submit(HttpRequest.create(GET_REST_REQUEST_DATA_TYPE_EXTERNAL_OBJECT_REST_API, getRestRequestDataTypeExternalObjectHttpUrl, HttpMethod.POST, request, null, 0, getRestRequestDataTypeExternalObjectRequestSerializer.serialize(request)), getRestRequestDataTypeExternalObjectResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<GenericResponse> postRestRequestDataTypeRawObject(Object request) {\n"
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_RAW_OBJECT_REST_API, postRestRequestDataTypeRawObjectHttpUrl, HttpMethod.POST, request, null, 0, postRestRequestDataTypeRawObjectRequestSerializer.serialize(request)), postRestRequestDataTypeRawObjectResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
  ...
  public void testGenerateExchangeApiDifferentRestEndpointQueryParamsDefinitions() throws Exception {
    ...
    Assert.assertEquals("package com.foo.bar.gen.restapi;\n"
        ...
        + "import com.foo.bar.gen.restapi.serializers.PersonSerializer;\n"
        + "import javax.annotation.processing.Generated;\n"
        + "import org.jxapi.exchange.AbstractExchangeApi;\n"
        + "import org.jxapi.netutils.deserialization.MessageDeserializer;\n"
        + "import org.jxapi.netutils.deserialization.json.field.ListJsonFieldDeserializer;\n"
        ...
        + "  \n"
        + "  // Request serializers\n"
        + "  private final MessageSerializer<Person> putRestRequestDataTypeObjectRequestSerializer = new PersonSerializer();\n"
        + "  private final MessageSerializer<Person> putRestRequestDataTypeObjectRequestSerializer = new PersonSerializer();\n"
        + "  private final MessageSerializer<Person> putRestRequestDataTypeObjectUsingDefaultQueryParamsRequestSerializer = new PersonSerializer();\n"
        + "  private final MessageSerializer<List<Integer>> postRestRequestDataTypeIntListAsQueryParamRequestSerializer = new ListJsonValueSerializer<>(IntegerJsonValueSerializer.getInstance());\n"
        + "  \n"
        + "  // Message deserializers\n"
        ...
        + "      .append(EncodingUtil.createUrlQueryParameters(\"id\", request)).toString();\n"
        + "    return submit(HttpRequest.create(DELETE_REST_REQUEST_DATA_TYPE_INT_REST_API, url, HttpMethod.DELETE, request, null, 0), deleteRestRequestDataTypeIntResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "      .append(EncodingUtil.createUrlQueryParameters(\"id\", request)).toString();\n"
        + "    return submit(HttpRequest.create(DELETE_REST_REQUEST_DATA_TYPE_INT_AS_QUERY_PARAM_REST_API, url, HttpMethod.DELETE, request, null, 0), deleteRestRequestDataTypeIntAsQueryParamResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "      .append(EncodingUtil.createUrlQueryParameters(\"age\", request.getAge(), \"city\", request.getCity())).toString();\n"
        + "    return submit(HttpRequest.create(DELETE_REST_REQUEST_DATA_TYPE_OBJECT_REST_API, url, HttpMethod.DELETE, request, null, 0), deleteRestRequestDataTypeObjectResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        + "  public FutureRestResponse<GenericResponse> putRestRequestDataTypeObject(Person request) {\n"
        + "    return submit(HttpRequest.create(PUT_REST_REQUEST_DATA_TYPE_OBJECT_REST_API, putRestRequestDataTypeObjectHttpUrl, HttpMethod.PUT, request, null, 0, putRestRequestDataTypeObjectRequestSerializer.serialize(request)), putRestRequestDataTypeObjectResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "      .append(EncodingUtil.createUrlQueryParameters(\"request\", JsonUtil.pojoToJsonString(request))).toString();\n"
        + "    return submit(HttpRequest.create(PUT_REST_REQUEST_DATA_TYPE_OBJECT_USING_DEFAULT_QUERY_PARAMS_REST_API, url, HttpMethod.PUT, request, null, 0, putRestRequestDataTypeObjectUsingDefaultQueryParamsRequestSerializer.serialize(request)), putRestRequestDataTypeObjectUsingDefaultQueryParamsResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_INT_LIST_AS_QUERY_PARAM_REST_API, url, HttpMethod.POST, request, null, 0, postRestRequestDataTypeIntListAsQueryParamRequestSerializer.serialize(request)), postRestRequestDataTypeIntListAsQueryParamResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
  ...
  public void testGenerateConflictExchangeV1Api() throws Exception {
    ...
    Assert.assertEquals("package org.jxapi.exchanges.conflict.gen.v1;\n"
        ...
        + "  \n"
        + "  // Message deserializers\n"
        + "  private final MessageDeserializer<String> myRestEndpointResponseDeserializer = MessageDeserializer.NO_OP;\n"
        + "  private final MessageDeserializer<String> aResponseDeserializer = StringJsonFieldDeserializer.getInstance();\n"
        + "  private final MessageDeserializer<String> AResponseDeserializer = StringJsonFieldDeserializer.getInstance();\n"
        + "  \n"
        + "  // Constructor\n"
        + "  /**\n"
        ...
        + "    this.aWs = createWebsocketEndpoint(A_WS_API, StringJsonFieldDeserializer.getInstance());\n"
        + "    this.AWs = createWebsocketEndpoint(A_WS_API_, StringJsonFieldDeserializer.getInstance());\n"
        + "  }\n"
        + "  \n"
        + "  // REST endpoint method call implementations\n"
        + "  @Override\n"
        ...
        + "    return submit(HttpRequest.create(MY_REST_ENDPOINT_REST_API, url, HttpMethod.GET, request, null, 0), myRestEndpointResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "      .append(EncodingUtil.createUrlQueryParameters(\"request\", JsonUtil.pojoToJsonString(request))).toString();\n"
        + "    return submit(HttpRequest.create(A_REST_API, url, HttpMethod.GET, request, null, 0), aResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  @Override\n"
        ...
        + "    String url = new StringBuilder(128).append(AHttpUrl)\n"
        + "      .append(EncodingUtil.createUrlQueryParameters(\"request\", JsonUtil.pojoToJsonString(request))).toString();\n"
        + "    return submit(HttpRequest.create(A_REST_API_, url, HttpMethod.GET, request, null, 0), AResponseDeserializer);\n"
        + "  }\n"
        + "  \n"
        + "  \n"
        + "  // Websocket endpoint subscribe/unsubscribe methods implementations\n"
