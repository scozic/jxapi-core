...
public class MockWebsocketHookEventTest {
  ...
  public void testCreateGetSubscribeRequestMessageEvent() {
    String topic = "testTopic";
    WebsocketSubscribeRequest request = WebsocketSubscribeRequest.create("susbcribe", topic, null);
    MockWebsocketHookEvent event = MockWebsocketHookEvent.createGetSubscribeRequestMessageEvent(mockWebsocketHook, request);
  ...
  public void testCreateGetUnSubscribeRequestMessageEvent() {
    String topic = "testTopic";
    WebsocketSubscribeRequest request = WebsocketSubscribeRequest.create("susbcribe", topic, null);
    MockWebsocketHookEvent event = MockWebsocketHookEvent.createGetUnSubscribeRequestMessageEvent(mockWebsocketHook,
        request);
