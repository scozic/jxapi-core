...
/**
 * Snippet to test call to {@link com.scz.jcex.exchanges.kucoin.gen.futurestrading.KucoinFuturesTradingApi#getUntriggeredStopOrderList(com.scz.jcex.exchanges.kucoin.gen.futurestrading.pojo.KucoinGetUntriggeredStopOrderListRequest)}
...
public class KucoinFuturesTradingGetUntriggeredStopOrderListDemo {
  ...
  public static void main(String[] args) {
    try {
      ...
      log.info("Calling 'com.scz.jcex.exchanges.kucoin.gen.futurestrading.KucoinFuturesTradingApi.getUntriggeredStopOrderList() API with request:" + request);
