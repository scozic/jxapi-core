...
/**
 * Snippet to test call to {@link com.scz.jcex.exchanges.kucoin.gen.spotmarketdata.KucoinSpotMarketDataApi#subscribeAllSymbolsTickerStream(com.scz.jcex.exchanges.kucoin.gen.spotmarketdata.pojo.KucoinAllSymbolsTickerStreamRequest)}
...
public class KucoinSpotMarketDataAllSymbolsTickerStreamDemo {
  ...
  public static void main(String[] args) {
    try {
      ...
      log.info("Subscribing to stream com.scz.jcex.exchanges.kucoin.gen.spotmarketdata.KucoinSpotMarketDataApi.subscribeAllSymbolsTickerStream() websocket stream with request:" + request);
