...
public class ExchangeApiDescriptorTest {
    ...
    public void testToString() {
        ...
        apiDescriptor.setRateLimits(List.of(new RateLimitRule()));
        Assert.assertEquals(
        		"ExchangeApiDescriptor{\"description\":\"description\",\"httpRequestExecutorFactory\":\"com.scz.jxapi.netutils.rest.mock.MockHttpRequestExecutorFactory\",\"httpRequestInterceptorFactory\":\"com.scz.jxapi.netutils.rest.mock.MockHttpRequestInterceptorFactory\",\"httpRequestTimeout\":-1,\"name\":\"name\",\"rateLimits\":[{\"maxRequestCount\":-1,\"maxTotalWeight\":-1,\"timeFrame\":0}],\"restEndpoints\":[{\"queryParams\":false}],\"websocketEndpoints\":[{}]}", 
