...
public class RestEndpointDemoGeneratorTest {
	...
	public void testGenerateRestEndpointDemoNoArgEndpoint() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "\n"
				+ "/**\n"
				+ " * Snippet to test call to {@link com.foo.bar.gen.marketdata.MyTestCEXMarketDataApi#postRestRequestDataTypeObjectNoParameters()}<br/>\n"
				+ " * <br><strong>THIS CODE IS GENERATED. DO NOT EDIT MANUALLY!</strong>\n"
				+ " */\n"
				+ "public class MyTestCEXMarketDataPostRestRequestDataTypeObjectNoParametersDemo {\n"
				+ "  private static final Logger log = LoggerFactory.getLogger(MyTestCEXMarketDataPostRestRequestDataTypeObjectNoParametersDemo.class);\n"
				+ "  \n"
				+ "  public static void main(String[] args) {\n"
				+ "    try {\n"
				+ "      MyTestCEXMarketDataApi api = new MyTestCEXExchangeImpl(TestJXApiProperties.filterProperties(\"myTestCEX\", true)).getMyTestCEXMarketDataApi();\n"
				+ "      log.info(\"Calling com.foo.bar.gen.marketdata.MyTestCEXMarketDataApi.postRestRequestDataTypeObjectNoParameters() API\");\n"
