...
public class ExchangeApiInterfaceImplementationGeneratorTest {
	...
	public void testGenerateExchangeApi() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
				...
				+ "    this.websocketManager = createWebsocketManager(null, null, null);\n"
				+ "    this.tickerStreamWs = createWebsocketEndpoint(new MyTestExchangeMarketDataTickerStreamMessageDeserializer());\n"
				+ "  }\n"
				+ "  @Override\n"
	...
	public void testGenerateExchangeApiNoRestEndpoint() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
				...
				+ "    super(properties);\n"
				+ "    this.websocketManager = createWebsocketManager(null, null, null);\n"
				+ "    this.tickerStreamStringObjectTypeWs = createWebsocketEndpoint(new TickerMessageDeserializer());\n"
				+ "    this.tickerStreamStringRequestTypeWs = createWebsocketEndpoint(new TickerMessageDeserializer());\n"
				+ "  }\n"
				+ "  @Override\n"
	...
	public void testGenerateExchangeApiSpecificResponseDataTypes() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
				...
				+ "    this.httpRequestInterceptor = createHttpRequestInterceptor(\"com.foo.bar.BarRequestInterceptorFactory\");\n"
				+ "    this.websocketManager = createWebsocketManager(null, null, null);\n"
				+ "    this.subscribeTickerWs = createWebsocketEndpoint(new MyTestExchangeMarketDataSubscribeTickerMessageDeserializer());\n"
				+ "    this.subscribeTickertMapListStreamWs = createWebsocketEndpoint(new ListJsonFieldDeserializer<>(new MapJsonFieldDeserializer<>(new MyTestExchangeMarketDataSubscribeTickertMapListStreamMessageDeserializer())));\n"
				+ "  }\n"
				+ "  @Override\n"
	...
	public void testGenerateExchangeApiSpecificRequestDataTypes() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
				...
				+ "    this.httpRequestInterceptor = createHttpRequestInterceptor(\"com.foo.bar.BarRequestInterceptorFactory\");\n"
				+ "    this.websocketManager = createWebsocketManager(null, null, null);\n"
				+ "    this.streamWithObjectRequestDataTypeZeroParametersWs = createWebsocketEndpoint(new TickerDeserializer());\n"
				+ "    this.streamWithObjectRequestDataTypeOneParameterWs = createWebsocketEndpoint(new TickerDeserializer());\n"
				+ "    this.streamWithIntRequestDataTypeWs = createWebsocketEndpoint(new TickerDeserializer());\n"
				+ "    this.streamWithLongRequestDataTypeWs = createWebsocketEndpoint(new TickerDeserializer());\n"
				+ "    this.streamWithBigDecimalRequestDataTypeWs = createWebsocketEndpoint(new TickerDeserializer());\n"
				+ "    this.streamWithStringRequestDataTypeWs = createWebsocketEndpoint(new TickerDeserializer());\n"
				+ "    this.streamWithBooleanRequestDataTypeWs = createWebsocketEndpoint(new TickerDeserializer());\n"
				+ "    this.streamWithStringListRequestDataTypeWs = createWebsocketEndpoint(new TickerDeserializer());\n"
				+ "    this.streamWithObjectListMapRequestDataTypeWs = createWebsocketEndpoint(new TickerDeserializer());\n"
				+ "  }\n"
				+ "  @Override\n"
