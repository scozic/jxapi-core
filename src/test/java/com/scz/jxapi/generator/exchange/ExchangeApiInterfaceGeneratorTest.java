...
public class ExchangeApiInterfaceGeneratorTest {
	...
	public void testGenerateExchangeApiSpecificRequestDataTypes() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
				...
				+ "   */\n"
				+ "  FutureRestResponse<GenericResponse> postRestRequestDataTypeObjectNoParameters(MyTestCEXMarketDataPostRestRequestDataTypeObjectNoParametersRequest request);\n"
				+ "  /**\n"
				...
				+ "   * @return client subscriptionId to use for unsubscription\n"
				+ "   */\n"
				+ "  String subscribeStreamWithObjectRequestDataTypeZeroParameters(MyTestCEXMarketDataStreamWithObjectRequestDataTypeZeroParametersRequest request, WebsocketListener<Ticker> listener);\n"
				+ "  \n"
				+ "  /**\n"
