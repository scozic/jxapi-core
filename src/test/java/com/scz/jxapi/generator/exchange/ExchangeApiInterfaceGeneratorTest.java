...
public class ExchangeApiInterfaceGeneratorTest {
	...
	public void testGenerateExchangeApiSpecificRequestDataTypes() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
				...
				+ "   */\n"
				+ "  FutureRestResponse<GenericResponse> postRestRequestDataTypeObjectListMap(Map<String, List<MyTestCEXMarketDataPostRestRequestDataTypeObjectListMapRequest>> request);\n"
				+ "  \n"
				+ "  /**\n"
				...
				+ "   * @return client subscriptionId to use for unsubscription\n"
				+ "   */\n"
				+ "  String subscribeStreamWithObjectRequestDataTypeOneParameter(MyTestCEXMarketDataStreamWithObjectRequestDataTypeOneParameterRequest request, WebsocketListener<Ticker> listener);\n"
				+ "  \n"
				+ "  /**\n"
				...
				+ "   * Subscribe to stream with OBJECT_LIST_MAP request type\n"
				+ "   * \n"
				+ "   * @return client subscriptionId to use for unsubscription\n"
				+ "   */\n"
				+ "  String subscribeStreamWithObjectListMapRequestDataType(Map<String, List<MyTestCEXMarketDataStreamWithObjectListMapRequestDataTypeRequest>> request, WebsocketListener<Ticker> listener);\n"
				+ "  \n"
				+ "  /**\n"
