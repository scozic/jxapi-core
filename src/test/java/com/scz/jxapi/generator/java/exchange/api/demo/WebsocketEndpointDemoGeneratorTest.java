...
public class WebsocketEndpointDemoGeneratorTest {
	...
	public void testGenerateWebsocketEndpointDemoObjectRequest() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "  \n"
				+ "  /**\n"
				+ "   * Tests websocket stream subscription to {@link com.foo.bar.gen.marketdata.MyTestExchangeMarketDataApi#subscribeTickerStream(MyTestExchangeMarketDataTickerStreamRequest, WebsocketListener<MyTestExchangeMarketDataTickerStreamMessage>)}.\n"
				...
				+ "   */\n"
				+ "  public static void subscribe(MyTestExchangeMarketDataTickerStreamRequest request, WebsocketListener<MyTestExchangeMarketDataTickerStreamMessage> messageListener, Properties configProperties, ExchangeApiObserver apiObserver, long subscriptionDuration, long delayBeforeExitAfterUnsubscription) throws InterruptedException {\n"
				...
				+ "    try {\n"
				+ "      subscribe(createRequest(), DemoUtil::logWsMessage, TestJXApiProperties.filterProperties(MyTestExchangeExchange.ID, true), DemoUtil::logWsApiEvent, SUBSCRIPTION_DURATION, DELAY_BEFORE_EXIT_AFTER_UNSUBSCRIPTION);\n"
				+ "      System.exit(0);\n"
				+ "    } catch (Throwable t) {\n"
	...
	public void testGenerateWebsocketEndpointDemoSpecificRequesTypePrimitiveStringWithNamedArg() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "  \n"
				+ "  /**\n"
				+ "   * Tests websocket stream subscription to {@link com.foo.bar.gen.marketdata.MyTestExchangeMarketDataApi#subscribeStreamWithStringRequestDataType(String, WebsocketListener<Ticker>)}.\n"
				+ "   * <br>Websocket endpoint subscription will be performed using given websocket listener then after waiting for <code>subscriptionDuration</code> delay, unsubscription is performed.\n"
				+ "   * Finally waits for <code>delayBeforeExitAfterUnsubscription</code> delay before returning to make sure no more messages are dispatched.\n"
				+ "   * @param request                            The subscription request\n"
				+ "   * @param messageListener                    The listener that will receive messages dispatched while subscription is active\n"
				...
				+ "   * @throws InterruptedException eventually thrown while sleeping for <code>subscriptionDuration</code> or <code>delayBeforeExitAfterUnsubscription</code> delays\n"
				+ "   */\n"
				+ "  public static void subscribe(String request, WebsocketListener<Ticker> messageListener, Properties configProperties, ExchangeApiObserver apiObserver, long subscriptionDuration, long delayBeforeExitAfterUnsubscription) throws InterruptedException {\n"
				+ "    MyTestExchangeMarketDataApi api = new MyTestExchangeExchangeImpl(\"test-\" + MyTestExchangeExchange.ID, configProperties).getMyTestExchangeMarketDataApi();\n"
				...
				+ "  public static void main(String[] args) {\n"
				+ "    try {\n"
				+ "      subscribe(createSymbol(), DemoUtil::logWsMessage, TestJXApiProperties.filterProperties(MyTestExchangeExchange.ID, true), DemoUtil::logWsApiEvent, SUBSCRIPTION_DURATION, DELAY_BEFORE_EXIT_AFTER_UNSUBSCRIPTION);\n"
				+ "      System.exit(0);\n"
				+ "    } catch (Throwable t) {\n"
				+ "      log.error(\"Exception raised from main()\", t);\n"
				+ "      System.exit(-1);\n"
	...
	public void testGenerateWebsocketEndpointDemoZeroArgs() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "  \n"
				+ "  /**\n"
				+ "   * Tests websocket stream subscription to {@link com.foo.bar.gen.marketdata.MyTestExchangeMarketDataApi#subscribeStreamWithObjectRequestDataTypeZeroParameters(WebsocketListener<Ticker>)}.\n"
				+ "   * <br>Websocket endpoint subscription will be performed using given websocket listener then after waiting for <code>subscriptionDuration</code> delay, unsubscription is performed.\n"
				+ "   * Finally waits for <code>delayBeforeExitAfterUnsubscription</code> delay before returning to make sure no more messages are dispatched.\n"
				+ "   * @param messageListener                    The listener that will receive messages dispatched while subscription is active\n"
				+ "   * @param configProperties                   Exchange configuration properties.\n"
				...
				+ "   * @throws InterruptedException eventually thrown while sleeping for <code>subscriptionDuration</code> or <code>delayBeforeExitAfterUnsubscription</code> delays\n"
				+ "   */\n"
				+ "  public static void subscribe(WebsocketListener<Ticker> messageListener, Properties configProperties, ExchangeApiObserver apiObserver, long subscriptionDuration, long delayBeforeExitAfterUnsubscription) throws InterruptedException {\n"
				+ "    MyTestExchangeMarketDataApi api = new MyTestExchangeExchangeImpl(\"test-\" + MyTestExchangeExchange.ID, configProperties).getMyTestExchangeMarketDataApi();\n"
				...
				+ "  public static void main(String[] args) {\n"
				+ "    try {\n"
				+ "      subscribe(DemoUtil::logWsMessage, TestJXApiProperties.filterProperties(MyTestExchangeExchange.ID, true), DemoUtil::logWsApiEvent, SUBSCRIPTION_DURATION, DELAY_BEFORE_EXIT_AFTER_UNSUBSCRIPTION);\n"
				+ "      System.exit(0);\n"
				+ "    } catch (Throwable t) {\n"
				+ "      log.error(\"Exception raised from main()\", t);\n"
				+ "      System.exit(-1);\n"
	...
	public void testGenerateWebsocketEndpointSpecificRequestTypeObjectListMapWithObjectDefinedInDifferentAPI() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "  \n"
				+ "  /**\n"
				+ "   * Tests websocket stream subscription to {@link com.foo.bar.gen.marketdata.MyTestExchangeMarketDataApi#subscribeStreamWithObjectListMapRequestDataType(Map<String, List<MultiSymbol>>, WebsocketListener<Ticker>)}.\n"
				+ "   * <br>Websocket endpoint subscription will be performed using given websocket listener then after waiting for <code>subscriptionDuration</code> delay, unsubscription is performed.\n"
				+ "   * Finally waits for <code>delayBeforeExitAfterUnsubscription</code> delay before returning to make sure no more messages are dispatched.\n"
				+ "   * @param request                            The subscription request\n"
				+ "   * @param messageListener                    The listener that will receive messages dispatched while subscription is active\n"
				...
				+ "   * @throws InterruptedException eventually thrown while sleeping for <code>subscriptionDuration</code> or <code>delayBeforeExitAfterUnsubscription</code> delays\n"
				+ "   */\n"
				+ "  public static void subscribe(Map<String, List<MultiSymbol>> request, WebsocketListener<Ticker> messageListener, Properties configProperties, ExchangeApiObserver apiObserver, long subscriptionDuration, long delayBeforeExitAfterUnsubscription) throws InterruptedException {\n"
				+ "    MyTestExchangeMarketDataApi api = new MyTestExchangeExchangeImpl(\"test-\" + MyTestExchangeExchange.ID, configProperties).getMyTestExchangeMarketDataApi();\n"
