...
public class WebsocketEndpointDemoGeneratorTest {
	...
	public void testGenerateWebsocketEndpointDemoObjectRequest() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "\n"
				+ "/**\n"
				+ " * Snippet to test call to {@link MyTestExchangeMarketDataApi#subscribeTickerStream(MyTestExchangeMarketDataTickerStreamRequest, null)}.\n"
				...
				+ "  \n"
				+ "  /**\n"
				+ "   * {@link MyTestExchangeMarketDataApi#subscribeTickerStream(MyTestExchangeMarketDataTickerStreamRequest, WebsocketListener<MyTestExchangeMarketDataTickerStreamMessage>)}.\n"
				...
				+ "    log.info(\"Subscribing to websocket API 'MyTestExchange MarketData tickerStream' for {} ms with request:{}\", SUBSCRIPTION_DURATION, request);\n"
				+ "    if (apiObserver != null) {\n"
				...
				+ "                TestJXApiProperties.filterProperties(MyTestExchangeExchange.ID, true),\n"
	...
	public void testGenerateWebsocketEndpointDemoSpecificRequesTypePrimitiveStringWithNamedArg() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "\n"
				+ "/**\n"
				+ " * Snippet to test call to {@link MyTestExchangeMarketDataApi#subscribeStreamWithStringRequestDataType(String, null)}.\n"
				+ " * <br><strong>THIS CODE IS GENERATED. DO NOT EDIT MANUALLY!</strong>\n"
				+ " */\n"
				...
				+ "  \n"
				+ "  /**\n"
				+ "   * {@link MyTestExchangeMarketDataApi#subscribeStreamWithStringRequestDataType(String, WebsocketListener<Ticker>)}.\n"
				+ "   * <br>Websocket endpoint subscription will be performed using given websocket listener then after waiting for <code>subscriptionDuration</code> delay, unsubscription is performed.\n"
				+ "   * Finally waits for <code>delayBeforeExitAfterUnsubscription</code> delay before returning to make sure no more messages are dispatched.\n"
				+ "   * @param request                            The subscription request\n"
				+ "   * @param messageListener                    The listener that will receive messages dispatched while subscription is active\n"
				...
				+ "  	                           long delayBeforeExitAfterUnsubscription) throws InterruptedException {\n"
				+ "    MyTestExchangeMarketDataApi api = new MyTestExchangeExchangeImpl(\"test-\" + MyTestExchangeExchange.ID, configProperties).getMyTestExchangeMarketDataApi();\n"
				+ "    log.info(\"Subscribing to websocket API 'MyTestExchange MarketData streamWithStringRequestDataType' for {} ms with request:{}\", SUBSCRIPTION_DURATION, request);\n"
				+ "    if (apiObserver != null) {\n"
				+ "      api.subscribeObserver(apiObserver);\n"
	...
	public void testGenerateWebsocketEndpointDemoZeroArgs() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "\n"
				+ "/**\n"
				+ " * Snippet to test call to {@link MyTestExchangeMarketDataApi#subscribeStreamWithObjectRequestDataTypeZeroParameters(null)}.\n"
				+ " * <br><strong>THIS CODE IS GENERATED. DO NOT EDIT MANUALLY!</strong>\n"
				+ " */\n"
				...
				+ "  \n"
				+ "  /**\n"
				+ "   * {@link MyTestExchangeMarketDataApi#subscribeStreamWithObjectRequestDataTypeZeroParameters(WebsocketListener<Ticker>)}.\n"
				+ "   * <br>Websocket endpoint subscription will be performed using given websocket listener then after waiting for <code>subscriptionDuration</code> delay, unsubscription is performed.\n"
				+ "   * Finally waits for <code>delayBeforeExitAfterUnsubscription</code> delay before returning to make sure no more messages are dispatched.\n"
				+ "   * @param messageListener                    The listener that will receive messages dispatched while subscription is active\n"
				+ "   * @param configProperties                   Exchange configuration properties.\n"
				...
				+ "  	                           long delayBeforeExitAfterUnsubscription) throws InterruptedException {\n"
				+ "    MyTestExchangeMarketDataApi api = new MyTestExchangeExchangeImpl(\"test-\" + MyTestExchangeExchange.ID, configProperties).getMyTestExchangeMarketDataApi();\n"
				+ "    log.info(\"Subscribing to websocket API 'MyTestExchange MarketData streamWithObjectRequestDataTypeZeroParameters' for {} ms\", SUBSCRIPTION_DURATION);\n"
				+ "    if (apiObserver != null) {\n"
				+ "      api.subscribeObserver(apiObserver);\n"
	...
	public void testGenerateWebsocketEndpointSpecificRequestTypeObjectListMapWithObjectDefinedInDifferentAPI() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "\n"
				+ "/**\n"
				+ " * Snippet to test call to {@link MyTestExchangeMarketDataApi#subscribeStreamWithObjectListMapRequestDataType(Map<String, List<MultiSymbol>>, null)}.\n"
				+ " * <br><strong>THIS CODE IS GENERATED. DO NOT EDIT MANUALLY!</strong>\n"
				+ " */\n"
				...
				+ "  \n"
				+ "  /**\n"
				+ "   * {@link MyTestExchangeMarketDataApi#subscribeStreamWithObjectListMapRequestDataType(Map<String, List<MultiSymbol>>, WebsocketListener<Ticker>)}.\n"
				+ "   * <br>Websocket endpoint subscription will be performed using given websocket listener then after waiting for <code>subscriptionDuration</code> delay, unsubscription is performed.\n"
				+ "   * Finally waits for <code>delayBeforeExitAfterUnsubscription</code> delay before returning to make sure no more messages are dispatched.\n"
				+ "   * @param request                            The subscription request\n"
				+ "   * @param messageListener                    The listener that will receive messages dispatched while subscription is active\n"
				...
				+ "  	                           long delayBeforeExitAfterUnsubscription) throws InterruptedException {\n"
				+ "    MyTestExchangeMarketDataApi api = new MyTestExchangeExchangeImpl(\"test-\" + MyTestExchangeExchange.ID, configProperties).getMyTestExchangeMarketDataApi();\n"
				+ "    log.info(\"Subscribing to websocket API 'MyTestExchange MarketData streamWithObjectListMapRequestDataType' for {} ms with request:{}\", SUBSCRIPTION_DURATION, request);\n"
				+ "    if (apiObserver != null) {\n"
				+ "      api.subscribeObserver(apiObserver);\n"
