...
public class RestEndpointDemoGeneratorTest {
	...
	public void testGenerateRestEndpointDemo() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "  }\n"
				+ "  \n"
				+ "  public static FutureRestResponse<MyTestExchangeMarketDataExchangeInfoResponse> execute(request, Properties configProperties) throws InterruptedException, ExecutionException {\n"
				...
				+ "    try {\n"
				+ "      execute(createRequest(), TestJXApiProperties.filterProperties(MyTestExchangeExchange.ID, true));\n"
				+ "      System.exit(0);\n"
				+ "    } catch (Throwable t) {\n"
	...
	public void testGenerateRestEndpointDemoSpecificRequesTypePrimitiveInt() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "  }\n"
				+ "  \n"
				+ "  public static FutureRestResponse<GenericResponse> execute(request, Properties configProperties) throws InterruptedException, ExecutionException {\n"
				+ "    MyTestExchangeMarketDataApi api = new MyTestExchangeExchangeImpl(\"test-\" + MyTestExchangeExchange.ID, configProperties).getMyTestExchangeMarketDataApi();\n"
	...
	public void testGenerateRestEndpointDemoSpecificRequesTypePrimitiveStringWithNamedArg() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "  public static void main(String[] args) {\n"
				+ "    try {\n"
				+ "      execute(createHello(), TestJXApiProperties.filterProperties(MyTestExchangeExchange.ID, true));\n"
				+ "      System.exit(0);\n"
				+ "    } catch (Throwable t) {\n"
				+ "      log.error(\"Exception raised from main()\", t);\n"
				+ "      System.exit(-1);\n"
	...
	public void testGenerateRestEndpointDemoNoArgEndpoint() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata.demo;\n"
				...
				+ "  \n"
				+ "  public static FutureRestResponse<GenericResponse> execute(Properties configProperties) throws InterruptedException, ExecutionException {\n"
				+ "    MyTestExchangeMarketDataApi api = new MyTestExchangeExchangeImpl(\"test-\" + MyTestExchangeExchange.ID, configProperties).getMyTestExchangeMarketDataApi();\n"
				...
				+ "  public static void main(String[] args) {\n"
				+ "    try {\n"
				+ "      execute(TestJXApiProperties.filterProperties(MyTestExchangeExchange.ID, true));\n"
				+ "      System.exit(0);\n"
				+ "    } catch (Throwable t) {\n"
				+ "      log.error(\"Exception raised from main()\", t);\n"
				+ "      System.exit(-1);\n"
