...
public class ExchangeApiInterfaceImplementationGeneratorTest {
	...
	public void testGenerateExchangeApiSpecificRequestDataTypes() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
				...
				+ "    return submit(HttpRequest.create(POST_REST_REQUEST_DATA_TYPE_STRING_REST_API, POST_REST_REQUEST_DATA_TYPE_STRING_URL, HttpMethod.POST, request, null, 0, serializeRequestBody(request)), postRestRequestDataTypeStringResponseDeserializer);\n"
				+ "  }\n"
				+ "  \n"
				+ "  @Override\n"
