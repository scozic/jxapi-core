...
public class ExchangeApiInterfaceImplementationGeneratorTest {
	...
	public void testGenerateExchangeApiNoRestEndpoint() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(request, topic, topicMatcher(\"subject\", \"ticker\", \"symbol\", \"\" + request.getSymbol()));\n"
				+ "    websocketSubscribeRequest.setRequest(request);\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(request, topic, topicMatcher(\"subject\", \"\" + topic, \"symbol\", \"\" + request));\n"
				+ "    websocketSubscribeRequest.setRequest(request);\n"
	...
	public void testGenerateExchangeApiSpecificResponseDataTypes() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(null, topic, topicMatcher(\"topic\", \"tickerMapList\"));\n"
	...
	public void testGenerateExchangeApiSpecificRequestDataTypes() throws Exception {
		...
		Assert.assertEquals("package com.foo.bar.gen.marketdata;\n"
				...
				+ "  public static final String POST_REST_REQUEST_DATA_TYPE_OBJECT_ONE_PARAMETER_URL = HTTP_URL + \"/postBigDecimal\";\n"
				+ "  public static final String POST_REST_REQUEST_DATA_TYPE_INT_LIST_URL = HTTP_URL + \"/postBigDecimal\";\n"
				+ "  public static final String POST_REST_REQUEST_DATA_TYPE_OBJECT_LIST_MAP_URL = HTTP_URL + \"/postBigDecimal\";\n"
				+ "  public static final String GET_REST_REQUEST_DATA_TYPE_OBJECT_LIST_MAP_URL = HTTP_URL + \"/postInt\";\n"
				+ "  public static final String GET_REST_REQUEST_DATA_TYPE_EMPTY_OBJECT_URL = HTTP_URL + \"/postInt\";\n"
				+ "  public static final String GET_REST_REQUEST_DATA_TYPE_PRIMITIVE_WITH_MSG_FIELD_URL = HTTP_URL + \"/postInt\";\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(null, topic, topicMatcher(\"topic\", \"streamWithObjectRequestDataTypeZeroParametersTopic\"));\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(request, topic, topicMatcher(\"topic\", \"\" + topic));\n"
				+ "    websocketSubscribeRequest.setRequest(request);\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(request, topic, topicMatcher(\"topic\", \"streamWithIntRequestDataTypeTopic\"));\n"
				+ "    websocketSubscribeRequest.setRequest(request);\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(request, topic, topicMatcher(\"topic\", \"streamWithLongRequestDataTypeTopic\"));\n"
				+ "    websocketSubscribeRequest.setRequest(request);\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(request, topic, topicMatcher(\"topic\", \"streamWithBigDecimalRequestDataTypeTopic\"));\n"
				+ "    websocketSubscribeRequest.setRequest(request);\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(request, topic, topicMatcher(\"topic\", \"streamWithStringRequestDataTypeTopic\"));\n"
				+ "    websocketSubscribeRequest.setRequest(request);\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(request, topic, topicMatcher(\"topic\", \"streamWithBooleanRequestDataTypeTopic\"));\n"
				+ "    websocketSubscribeRequest.setRequest(request);\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(request, topic, topicMatcher(\"topic\", \"streamWithObjectListMapRequestDataTypeTopic\"));\n"
				+ "    websocketSubscribeRequest.setRequest(request);\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(null, topic, topicMatcher());\n"
				...
				+ "    WebsocketSubscribeRequest websocketSubscribeRequest = WebsocketSubscribeRequest.create(request, topic, topicMatcher(\"topic\", \"ticker:\" + request));\n"
				+ "    websocketSubscribeRequest.setRequest(request);\n"
