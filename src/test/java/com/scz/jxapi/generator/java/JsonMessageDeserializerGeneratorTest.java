...
import com.scz.jxapi.generator.java.exchange.api.pojo.JsonMessageDeserializerGenerator;
...
public class JsonMessageDeserializerGeneratorTest {
	...
	public void testGenerateDeserializer() {
		...
		endpointParameters.add(Field.createObject( "OBJECT", "titi", "ti", null,
				Arrays.asList(Field.create(CanonicalType.STRING.name(), "name", null, "Titi name", "TiName"))
				));
