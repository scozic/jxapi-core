...
/**
 * Snippet to test call to {@link com.scz.jxapi.exchanges.binance.gen.spottrading.BinanceSpotTradingApi#spotKeepAliveListenKey(com.scz.jxapi.exchanges.binance.gen.spottrading.pojo.BinanceSpotKeepAliveListenKeyRequest)}
...
public class BinanceSpotTradingSpotKeepAliveListenKeyDemo {
  ...
  public static void main(String[] args) {
    try {
      ...
      log.info("Calling 'com.scz.jxapi.exchanges.binance.gen.spottrading.BinanceSpotTradingApi.spotKeepAliveListenKey() API with request:" + request);
