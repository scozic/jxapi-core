...
/**
 * Snippet to test call to {@link com.scz.jxapi.exchanges.binance.gen.spottrading.BinanceSpotTradingApi#subscribeBalanceUpdateUserDataStream(com.scz.jxapi.exchanges.binance.gen.spottrading.pojo.BinanceBalanceUpdateUserDataStreamRequest)}
...
public class BinanceSpotTradingBalanceUpdateUserDataStreamDemo {
  ...
  public static void main(String[] args) {
    try {
      ...
      log.info("Subscribing to stream com.scz.jxapi.exchanges.binance.gen.spottrading.BinanceSpotTradingApi.subscribeBalanceUpdateUserDataStream() websocket stream with request:" + request);
