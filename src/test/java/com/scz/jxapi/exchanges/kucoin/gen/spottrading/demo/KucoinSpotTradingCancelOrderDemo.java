...
/**
 * Snippet to test call to {@link com.scz.jxapi.exchanges.kucoin.gen.spottrading.KucoinSpotTradingApi#cancelOrder(com.scz.jxapi.exchanges.kucoin.gen.spottrading.pojo.KucoinCancelOrderRequest)}
...
public class KucoinSpotTradingCancelOrderDemo {
  ...
  public static void main(String[] args) {
    try {
      ...
      log.info("Calling 'com.scz.jxapi.exchanges.kucoin.gen.spottrading.KucoinSpotTradingApi.cancelOrder() API with request:" + request);
