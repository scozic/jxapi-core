...
public class KucoinSpotTradingAccountBalanceNoticeDemo {
  ...
  public static void main(String[] args) {
    try {
      ...
      log.info("Subscribing to stream com.scz.jxapi.exchanges.kucoin.gen.spottrading.KucoinSpotTradingApi.subscribeAccountBalanceNotice() websocket stream with request:" + request);
