...
/**
 * Snippet to test call to {@link com.scz.jxapi.exchanges.kucoin.gen.spottrading.KucoinSpotTradingApi#subscribePrivateOrderChangeV2(com.scz.jxapi.exchanges.kucoin.gen.spottrading.pojo.KucoinPrivateOrderChangeV2Request)}
...
public class KucoinSpotTradingPrivateOrderChangeV2Demo {
  ...
  public static void main(String[] args) {
    try {
      ...
      log.info("Subscribing to stream com.scz.jxapi.exchanges.kucoin.gen.spottrading.KucoinSpotTradingApi.subscribePrivateOrderChangeV2() websocket stream with request:" + request);
