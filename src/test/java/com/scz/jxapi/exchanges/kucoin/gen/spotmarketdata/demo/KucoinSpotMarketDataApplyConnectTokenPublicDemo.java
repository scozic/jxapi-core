...
/**
 * Snippet to test call to {@link com.scz.jxapi.exchanges.kucoin.gen.spotmarketdata.KucoinSpotMarketDataApi#applyConnectTokenPublic(com.scz.jxapi.exchanges.kucoin.gen.spotmarketdata.pojo.KucoinApplyConnectTokenPublicRequest)}
...
public class KucoinSpotMarketDataApplyConnectTokenPublicDemo {
  ...
  public static void main(String[] args) {
    try {
      ...
      log.info("Calling 'com.scz.jxapi.exchanges.kucoin.gen.spotmarketdata.KucoinSpotMarketDataApi.applyConnectTokenPublic() API with request:" + request);
