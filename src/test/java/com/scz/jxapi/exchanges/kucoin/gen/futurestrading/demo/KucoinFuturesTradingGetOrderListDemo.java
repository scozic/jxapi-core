...
/**
 * Snippet to test call to {@link com.scz.jxapi.exchanges.kucoin.gen.futurestrading.KucoinFuturesTradingApi#getOrderList(com.scz.jxapi.exchanges.kucoin.gen.futurestrading.pojo.KucoinGetOrderListRequest)}
...
public class KucoinFuturesTradingGetOrderListDemo {
  ...
  public static void main(String[] args) {
    try {
      ...
      log.info("Calling 'com.scz.jxapi.exchanges.kucoin.gen.futurestrading.KucoinFuturesTradingApi.getOrderList() API with request:" + request);
