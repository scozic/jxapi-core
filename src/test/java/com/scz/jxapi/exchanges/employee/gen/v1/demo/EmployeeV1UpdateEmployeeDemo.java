...
/**
 * Snippet to test call to {@link EmployeeV1Api#updateEmployee(com.scz.jxapi.exchanges.employee.gen.v1.pojo.Employee)})}<br>
 */
...
public class EmployeeV1UpdateEmployeeDemo {
  ...
  /**
   * Submits a call to {@link EmployeeV1Api#updateEmployee(com.scz.jxapi.exchanges.employee.gen.v1.pojo.Employee)}and waits for response.
  ...
  public static RestResponse<String> execute(Employee request, Properties configProperties, ExchangeApiObserver apiObserver) throws InterruptedException, ExecutionException {
    ...
    log.info("Calling com.scz.jxapi.exchanges.employee.gen.v1.EmployeeV1Api.updateEmployee() API with request:{}", request);
    if (apiObserver != null) {
  ...
  /**
   * Runs REST endpoint demo snippet calling {@link EmployeeV1Api#updateEmployee(com.scz.jxapi.exchanges.employee.gen.v1.pojo.Employee)}
