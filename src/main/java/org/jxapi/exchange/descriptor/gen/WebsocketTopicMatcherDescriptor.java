...
public class WebsocketTopicMatcherDescriptor implements Pojo<WebsocketTopicMatcherDescriptor> {
  ...
  /**
   * @return The list of sub-matchers that must all match in incoming messages to identify those belonging to this topic. This is a logical AND operation.
   * 
   */
  ...
  /**
   * @param and The list of sub-matchers that must all match in incoming messages to identify those belonging to this topic. This is a logical AND operation.
   * 
   */
  ...
  /**
   * @return The list of sub-matchers where at least one must match in incoming messages to identify those belonging to this topic. This is a logical OR operation.
   * 
   */
  ...
  /**
   * @param or The list of sub-matchers where at least one must match in incoming messages to identify those belonging to this topic. This is a logical OR operation.
   * 
   */
