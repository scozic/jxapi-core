...
public class WebsocketEndpointDescriptor {
	 ...
	 * that may disseminate messages for several multiplexed streams.
	 * <br/>
	 * Topic can contain reference to whole request of request property value for instance 
	...
	/**
	 * @return the list of field matchers that can be used to match the topic of a message
	 *         received on the websocket. To match a topic, the message must match all matchers.
	 */
	...
	/**
	 * Set the list of field matchers that can be used to match the topic of a message
	 * received on the websocket. To match a topic, the message must match all matchers.
