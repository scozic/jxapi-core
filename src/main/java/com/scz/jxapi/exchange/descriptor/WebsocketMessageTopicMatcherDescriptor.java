...
/**
 * When subscribing to a websocket endpoint, a topic is extracted from the message stream and matched against the topic of the endpoint.
 * The way the message is matched against the topic is described by a list of fields that are extracted from the message and must all match an expected value.
 * This class stands for part of {@link WebsocketEndpointDescriptor} describing the list of field matchers that must all match for the message to be considered as matching the topic.
 * 
