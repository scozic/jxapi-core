...
public class KucoinFuturesPublicWebsocketEndpointFactory extends AbstractWebsocketEndpointFactory {

	public static final String BASE_URL = "wss://ws-api-spot.kucoin.com/";
	public static final String TOKEN_API_BASE_URL = "https://api-futures.kucoin.com/api/v1/";

	public KucoinFuturesPublicWebsocketEndpointFactory() {
		super();
	}
