...
/**
 * Jackson JSON Serializer for com.scz.jxapi.exchanges.kucoin.gen.spotmarketdata.pojo.KucoinIndividualSymbolTickerStreamsMessageData
 * <br><strong>THIS CODE IS GENERATED. DO NOT EDIT MANUALLY!</strong>
 * @see KucoinIndividualSymbolTickerStreamsMessageData
 */
public class KucoinIndividualSymbolTickerStreamsMessageDataSerializer extends StdSerializer<KucoinIndividualSymbolTickerStreamsMessageData> {
  public KucoinIndividualSymbolTickerStreamsMessageDataSerializer() {
    super(KucoinIndividualSymbolTickerStreamsMessageData.class);
  }
  
  @Override
  public void serialize(KucoinIndividualSymbolTickerStreamsMessageData value, JsonGenerator gen, SerializerProvider provider) throws IOException {
