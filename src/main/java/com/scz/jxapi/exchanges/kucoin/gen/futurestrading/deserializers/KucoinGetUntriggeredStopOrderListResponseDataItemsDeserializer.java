...
import com.scz.jxapi.exchanges.kucoin.gen.futurestrading.pojo.KucoinGetUntriggeredStopOrderListResponseDataItems;
...
/**
 * Parses incoming JSON messages into com.scz.jxapi.exchanges.kucoin.gen.futurestrading.pojo.KucoinGetUntriggeredStopOrderListResponseDataItems instances
 * <br><strong>THIS CODE IS GENERATED. DO NOT EDIT MANUALLY!</strong>
 * @see com.scz.jxapi.exchanges.kucoin.gen.futurestrading.pojo.KucoinGetUntriggeredStopOrderListResponseDataItems
 */
public class KucoinGetUntriggeredStopOrderListResponseDataItemsDeserializer extends AbstractJsonMessageDeserializer<KucoinGetUntriggeredStopOrderListResponseDataItems> {
  
  @Override
  public KucoinGetUntriggeredStopOrderListResponseDataItems deserialize(JsonParser parser) throws IOException {
    KucoinGetUntriggeredStopOrderListResponseDataItems msg = new KucoinGetUntriggeredStopOrderListResponseDataItems();
    while(parser.nextToken() != JsonToken.END_OBJECT) {
      ...
      break;
      case "value":
        msg.setValue(readNextBigDecimal(parser));
      break;
      case "stp":
