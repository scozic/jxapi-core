...
/**
 * Jackson JSON Serializer for com.scz.jxapi.exchanges.kucoin.gen.futurestrading.pojo.KucoinGetOrderListResponseDataItems
 * <br><strong>THIS CODE IS GENERATED. DO NOT EDIT MANUALLY!</strong>
 * @see KucoinGetOrderListResponseDataItems
 */
public class KucoinGetOrderListResponseDataItemsSerializer extends StdSerializer<KucoinGetOrderListResponseDataItems> {
  public KucoinGetOrderListResponseDataItemsSerializer() {
    super(KucoinGetOrderListResponseDataItems.class);
  }
  
  @Override
  public void serialize(KucoinGetOrderListResponseDataItems value, JsonGenerator gen, SerializerProvider provider) throws IOException {
