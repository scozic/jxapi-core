...
/**
 * Jackson JSON Serializer for com.scz.jxapi.exchanges.kucoin.gen.futurestrading.pojo.KucoinGetUntriggeredStopOrderListResponseDataItems
 * <br><strong>THIS CODE IS GENERATED. DO NOT EDIT MANUALLY!</strong>
 * @see KucoinGetUntriggeredStopOrderListResponseDataItems
 */
public class KucoinGetUntriggeredStopOrderListResponseDataItemsSerializer extends StdSerializer<KucoinGetUntriggeredStopOrderListResponseDataItems> {
  public KucoinGetUntriggeredStopOrderListResponseDataItemsSerializer() {
    super(KucoinGetUntriggeredStopOrderListResponseDataItems.class);
  }
  
  @Override
  public void serialize(KucoinGetUntriggeredStopOrderListResponseDataItems value, JsonGenerator gen, SerializerProvider provider) throws IOException {
