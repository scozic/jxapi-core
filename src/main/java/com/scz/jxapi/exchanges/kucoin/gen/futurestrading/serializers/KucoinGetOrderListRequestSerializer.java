...
/**
 * Jackson JSON Serializer for com.scz.jxapi.exchanges.kucoin.gen.futurestrading.pojo.KucoinGetOrderListRequest
 * <br><strong>THIS CODE IS GENERATED. DO NOT EDIT MANUALLY!</strong>
 * @see KucoinGetOrderListRequest
 */
public class KucoinGetOrderListRequestSerializer extends StdSerializer<KucoinGetOrderListRequest> {
  public KucoinGetOrderListRequestSerializer() {
    super(KucoinGetOrderListRequest.class);
  }
  
  @Override
  public void serialize(KucoinGetOrderListRequest value, JsonGenerator gen, SerializerProvider provider) throws IOException {
