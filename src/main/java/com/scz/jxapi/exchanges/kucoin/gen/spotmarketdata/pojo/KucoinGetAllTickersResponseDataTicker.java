...
import com.scz.jxapi.exchanges.kucoin.gen.spotmarketdata.serializers.KucoinGetAllTickersResponseDataTickerSerializer;
 ...
 */
@JsonSerialize(using = KucoinGetAllTickersResponseDataTickerSerializer.class)
public class KucoinGetAllTickersResponseDataTicker {
  ...
  /**
   * @param symbolName Name of trading pairs, it would change after renaming
   */
