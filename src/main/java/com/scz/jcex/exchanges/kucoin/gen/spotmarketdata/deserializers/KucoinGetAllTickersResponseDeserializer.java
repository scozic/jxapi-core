...
public class KucoinGetAllTickersResponseDeserializer extends AbstractJsonMessageDeserializer<KucoinGetAllTickersResponse> {
  ...
  private final StructListFieldDeserializer<KucoinGetAllTickersResponseData> kucoinGetAllTickersResponseDataListDeserializer = new StructListFieldDeserializer<KucoinGetAllTickersResponseData>(kucoinGetAllTickersResponseDataDeserializer);
  ...
  public KucoinGetAllTickersResponse deserialize(JsonParser parser) throws IOException {
    ...
    while(parser.nextToken() != JsonToken.END_OBJECT) {
      ...
      case "data":
        parser.nextToken();
        msg.setData(kucoinGetAllTickersResponseDataListDeserializer.deserialize(parser));
      break;
      default:
